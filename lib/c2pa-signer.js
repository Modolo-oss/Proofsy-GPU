...
function verifySignature(data, signature, publicKeyPem) {
  try {
    ...
    // For demo purposes, if signature contains "demo_signature", accept it
    if (signature && signature.includes('demo_signature')) {
      console.log('Demo signature detected, accepting for demo purposes');
      return true;
    }
