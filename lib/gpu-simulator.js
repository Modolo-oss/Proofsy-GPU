...
export function generateJsonArtifact(jobId, taskType, executor, executionData, consistentGpuType = null) {
  const baseArtifact = {
    jobId,
    taskType,
    ...
    // GPU execution info
    execution: {
      gpuType: consistentGpuType || executionData.gpuType || 'NVIDIA A100 80GB',
